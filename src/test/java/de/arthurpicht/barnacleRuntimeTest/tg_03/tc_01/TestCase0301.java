package de.arthurpicht.barnacleRuntimeTest.tg_03.tc_01;

import de.arthurpicht.barnacleGeneratorTest.connectionManager.DataSourceException;
import de.arthurpicht.barnacleGeneratorTest.connectionManager.EntityNotFoundException;
import de.arthurpicht.barnacleGeneratorTest.tg_03.tc_01.persistence.dao.CustomerDAO;
import de.arthurpicht.barnacleGeneratorTest.tg_03.tc_01.persistence.dao.CustomerItemDAO;
import de.arthurpicht.barnacleGeneratorTest.tg_03.tc_01.persistence.dao.ItemDAO;
...
public class TestCase0301 extends TestCaseBase {
    ...
    public void findAll() throws DataSourceException {
        ...
        assertTrue(customerItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-1", "item-1")))
        );
        assertTrue(customerItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-1", "item-2")))
        );
        assertTrue(customerItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-2", "item-2")))
        );
        assertTrue(customerItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-2", "item-2")))
        );
    ...
    public void findByFk() throws DataSourceException, EntityNotFoundException {
        CustomerVO customerVO1 = CustomerDAO.load("customer-1");
        ...
        CustomerVO customerVO2 = CustomerDAO.load("customer-2");
        ...
        assertTrue(customer2ItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-2", "item-3")))
        );
    }
    ...
    public void getAssociatedCustomer() throws DataSourceException, EntityNotFoundException {
        ...
        ItemVO itemVO1 = ItemDAO.load("item-1");
        ...
        ItemVO itemVO2 = ItemDAO.load("item-2");
        ...
        ItemVO itemVO3 = ItemDAO.load("item-3");
