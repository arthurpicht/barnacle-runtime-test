package de.arthurpicht.barnacleRuntimeTest.tg_03.tc_02;

import de.arthurpicht.barnacleGeneratorTest.connectionManager.DataSourceException;
import de.arthurpicht.barnacleGeneratorTest.connectionManager.EntityNotFoundException;
import de.arthurpicht.barnacleGeneratorTest.tg_03.tc_02.persistence.dao.CustomerDAO;
import de.arthurpicht.barnacleGeneratorTest.tg_03.tc_02.persistence.dao.CustomerItemDAO;
import de.arthurpicht.barnacleGeneratorTest.tg_03.tc_02.persistence.dao.ItemDAO;
import de.arthurpicht.barnacleGeneratorTest.tg_03.tc_02.persistence.vo.*;
...
public class TestCase0302 extends TestCaseBase {
    ...
    public void findAll() throws DataSourceException {
        ...
        assertTrue(customerItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-A-1", "customer-A-2", "item-1")))
        );
        assertTrue(customerItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-A-1", "customer-A-2", "item-2")))
        );
        assertTrue(customerItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-B-1", "customer-B-2", "item-2")))
        );
        assertTrue(customerItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-B-1", "customer-B-2", "item-2")))
        );
    ...
    public void findByFk() throws DataSourceException, EntityNotFoundException {
        ...
        assertTrue(customer2ItemVOList.contains(
                new CustomerItemVO(new CustomerItemPK("customer-B-1", "customer-B-2", "item-3")))
        );
    }
